...
/**
 * struct stack_s - doubly linked list representation for a stack and queue
 * @n: for integer
 ...
 * @opcode: opcode
 * @f: function that handle the opcode
 *
...
/**
 * struct bus_s - variable -args, file and line content
 * @arg: the value
